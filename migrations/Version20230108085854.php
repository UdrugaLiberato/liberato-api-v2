 ...
 */
final class Version20230108085854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD image_id INT NOT NULL, DROP icon');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD icon LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', DROP image_id');
    }
}
