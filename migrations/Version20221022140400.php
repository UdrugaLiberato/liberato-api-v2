 ...
 */
final class Version20221022140400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer ADD question_id VARCHAR(255) DEFAULT NULL, DROP question');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer ADD question VARCHAR(255) NOT NULL, DROP question_id');
    }
}
